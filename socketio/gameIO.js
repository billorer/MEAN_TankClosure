...
var lobbies = require('./lobbyIO');
var socketHashMapList = require('./lobbyIO');
...
setInterval(function(){
	...
	for(let socketKey in socketHashMapList){
		let socket = socketHashMapList[socketKey];
        //console.log("INITPACKAGE: " + initPack.id)
	    socket.emit('initializeGame', initPack);
